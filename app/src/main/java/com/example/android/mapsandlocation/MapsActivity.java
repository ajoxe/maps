...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private FusedLocationProviderClient mFusedLocationClient;//declaring variable, not instantiating
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFusedLocationClient = LocationServices.getFusedLocationProviderClient(this);//instantiating variable
        //static because we call class and not instance of class. getting acces to status methos that gives us locations resources
        //we pass in context to get acces to resources.
    }
